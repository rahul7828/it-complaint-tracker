...
export default function TicketList({ tickets, onSelect }: Props) {
  ...
  // ✅ FIX: agar already full URL hai to direct open karo
  if (fileUrl.startsWith("http")) {
    window.open(fileUrl, "_blank");

  } else {
    // ❌ fallback (agar kabhi path aaye)
...
// final ticket list working code before image file not downloading issue 03/04/26
// import React, { useMemo, useState } from "react";
// import ExcelJS from "exceljs";
...
// final working code before attachment download issue 02/04/26
// import React, { useMemo, useState } from "react";
// import ExcelJS from "exceljs";
...
///// final corking code before attachment not download 01/04/26
// import React, { useMemo, useState } from "react";
// import ExcelJS from "exceljs";
